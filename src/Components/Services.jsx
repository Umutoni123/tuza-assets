...
export default function Services() {
  return (
    <div>
      <div class="w-full px-4 bg-[#045501] text-white p-24 ">
        <div class=" mb-10 mx-auto max-w-[510px] text-center lg:mb-15">
          ...
          <p class="text-body-color text-base dark:text-dark-6 mb-10">
      ...
      <div className="  md:mb-10 mb-15 py-7  ">
        ...
        <img src={house} alt="Background of a house with a chimney" className="object-cover w-full h-full brightness-50" />
          ...
          <div class="absolute top-0 left-0  text-white grid md:grid-cols-3 max-w-screen-lg mx-auto gap-10 mt-16 p-5">
            <div class="flex gap-4 items-start flex-col border-l-lime-50 active:bg-green-900 focus:bg-green-900">
              <span class="text-orange-600 bg-orange-500/10 p-3 rounded-full">
                <svg
                  width="15"
                  height="15"
                  viewBox="0 0 15 15"
              ...
              <div>
                <h3 class="font-semibold text-xl"> Plots and Houses</h3>
            ...
            <div class="flex gap-4 items-start flex-col ">
              ...
              <div>
                <h3 class="font-semibold text-xl">Fund and Security</h3>
            ...
            <div class="flex gap-4 items-start flex-col ">
              ...
              <div>
                <h3 class="font-semibold text-xl">Real estate in Rwanda </h3>
                <p class="mt-1 text-gray-500">
                  {" "}
